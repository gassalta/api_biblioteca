/**
 * NOTA: En el siguiente código probamos las funciones definidas en el controlador libroController, pero
para no afectar los datos de la base de datos utilizamos un mockup (simulación) de libroModel (que
contiene la definición de mongoose para acceder a la base de datos).
 */
const {
    getAllLibros,
    createLibro,
